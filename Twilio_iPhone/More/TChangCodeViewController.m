...
@interface TChangCodeViewController ()

@end

@implementation TChangCodeViewController
@synthesize iputCode;

- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    self = [super initWithNibName:@"TChangCodeViewController" bundle:nibBundleOrNil];
    if (self) {
        self.title=@"修改号码";
    }
    return self;
...
- (void)initNavigationItem
{
	...
	[buyBtn addTarget:self action:nil forControlEvents:UIControlEventTouchUpInside];
...
{
    [self.iputCode resignFirstResponder];
}
